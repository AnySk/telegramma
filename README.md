...
<a href="https://github.com/AnySk/telegramma">
	<img src="https://img.shields.io/github/languages/top/AnySk/telegramma?style=flat-square&logo=github" alt="GitHub top language" />
</a>
</div>

</header>

> **Fork notice.** `telegramma` is a maintained fork of [Telegraf](https://github.com/telegraf/telegraf), published as **`@anysk/telegramma`**. It tracks the latest **Telegram Bot API (v10.3)** by depending on [`@anysk/telegramma-types`](https://github.com/AnySk/telegramma-types) and adding the corresponding API methods (ephemeral messages, rich messages, live photos, guest mode, poll media, join-request queries, etc.). The public API is otherwise unchanged from Telegraf v4.
...
- Full [Telegram Bot API 10.3](https://core.telegram.org/bots/api) support
